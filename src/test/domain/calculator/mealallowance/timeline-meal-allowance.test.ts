...
describe("TimelineMealAllowanceCalculator rates", () => {
  ...
  describe("calculate - Before Timeline Start", () => {
    it("should return default rates (0, 0) for year before 2000", () => {
      const result = calculator.calculateRates({ year: 1999, month: 12 });
    ...
    it("should return default rates for year 1990", () => {
      const result = calculator.calculateRates({ year: 1990, month: 6 });

      expect(result).toEqual(RATES_DEFAULT);
    });

    it("should return default rates for year 1980", () => {
      const result = calculator.calculateRates({ year: 1980, month: 1 });
    ...
    it("should return default rates for January 2000 (before month 1)", () => {
      ...
      const result = calculator.calculateRates({ year: 2000, month: 0 });
  ...
  describe("calculate - First Timeline Entry (2000-01)", () => {
    it("should return 2000 rates for January 2000 (exact match)", () => {
      const result = calculator.calculateRates({ year: 2000, month: 1 });
    ...
    it("should return 2000 rates for February 2000", () => {
      const result = calculator.calculateRates({ year: 2000, month: 2 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for June 2000", () => {
      const result = calculator.calculateRates({ year: 2000, month: 6 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for December 2000", () => {
      const result = calculator.calculateRates({ year: 2000, month: 12 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for year 2001", () => {
      const result = calculator.calculateRates({ year: 2001, month: 1 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for year 2010", () => {
      const result = calculator.calculateRates({ year: 2010, month: 6 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for year 2020", () => {
      const result = calculator.calculateRates({ year: 2020, month: 12 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for year 2023", () => {
      const result = calculator.calculateRates({ year: 2023, month: 12 });
  ...
  describe("calculate - Second Timeline Entry (2024-09)", () => {
    it("should return 2024 rates for September 2024 (exact match)", () => {
      const result = calculator.calculateRates({ year: 2024, month: 9 });
    ...
    it("should return 2024 rates for October 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 10 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should return 2024 rates for December 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 12 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should return 2024 rates for January 2025", () => {
      const result = calculator.calculateRates({ year: 2025, month: 1 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should return 2024 rates for year 2026", () => {
      const result = calculator.calculateRates({ year: 2026, month: 6 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should return 2024 rates for far future year 2030", () => {
      const result = calculator.calculateRates({ year: 2030, month: 12 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should return 2024 rates for year 2100", () => {
      const result = calculator.calculateRates({ year: 2100, month: 1 });
  ...
  describe("calculate - Transition Between Entries", () => {
    it("should return 2000 rates for January 2024 (before September)", () => {
      const result = calculator.calculateRates({ year: 2024, month: 1 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for February 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 2 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for March 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 3 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for April 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 4 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for May 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 5 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for June 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 6 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for July 2024", () => {
      const result = calculator.calculateRates({ year: 2024, month: 7 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should return 2000 rates for August 2024 (one month before)", () => {
      const result = calculator.calculateRates({ year: 2024, month: 8 });

      expect(result).toEqual(RATES_2000_01);
    });

    it("should transition to 2024 rates exactly at September 2024", () => {
      const august = calculator.calculateRates({ year: 2024, month: 8 });
      const september = calculator.calculateRates({ year: 2024, month: 9 });
  ...
  describe("calculate - Month Boundaries", () => {
    ...
    it("should handle month 12 (December/last month)", () => {
      const result2023 = calculator.calculateRates({ year: 2023, month: 12 });
      const result2024 = calculator.calculateRates({ year: 2024, month: 12 });
    ...
    it("should handle all months in year 2024", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculateRates({ year: 2024, month });
    ...
    it("should handle all months in year 2010", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculateRates({ year: 2010, month });
        expect(result).toEqual(RATES_2000_01);
      }
    });
    ...
    it("should handle all months in year 2025", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculateRates({ year: 2025, month });
        expect(result).toEqual(RATES_2024_09);
      }
    });
  });
  ...
  describe("calculate - Rate Values", () => {
    ...
    it("should show rate increase from 2000 to 2024", () => {
      const rates2000 = calculator.calculateRates({ year: 2020, month: 6 });
      const rates2024 = calculator.calculateRates({ year: 2024, month: 10 });
    ...
    it("should have large rate greater than small rate", () => {
      const rates2000 = calculator.calculateRates({ year: 2010, month: 6 });
      const rates2024 = calculator.calculateRates({ year: 2024, month: 10 });
  ...
  describe("calculate - Edge Cases", () => {
    it("should handle month 0 (edge case)", () => {
      const result = calculator.calculateRates({ year: 2024, month: 0 });
    ...
    it("should handle month 13 (edge case)", () => {
      const result = calculator.calculateRates({ year: 2024, month: 13 });
    ...
    it("should handle negative year (edge case)", () => {
      const result = calculator.calculateRates({ year: -1, month: 6 });

      expect(result).toEqual(RATES_DEFAULT);
    });

    it("should handle very large year", () => {
      const result = calculator.calculateRates({ year: 9999, month: 12 });

      expect(result).toEqual(RATES_2024_09);
    });

    it("should handle year 0 (edge case)", () => {
      const result = calculator.calculateRates({ year: 0, month: 1 });
  ...
  describe("calculate - Return Value Structure", () => {
    ...
    it("should return valid MealAllowanceRates structure even for dates before timeline", () => {
      const result = calculator.calculateRates({ year: 1990, month: 1 });
  ...
  describe("calculate - Consistency and Determinism", () => {
    it("should return consistent results for same input", () => {
      const result1 = calculator.calculateRates({ year: 2024, month: 10 });
      const result2 = calculator.calculateRates({ year: 2024, month: 10 });
      const result3 = calculator.calculateRates({ year: 2024, month: 10 });
    ...
    it("should return consistent results across multiple instances", () => {
      const calculator1 = new TimelineMealAllowanceCalculator();
      const calculator2 = new TimelineMealAllowanceCalculator();

      const result1 = calculator1.calculateRates({ year: 2024, month: 10 });
      const result2 = calculator2.calculateRates({ year: 2024, month: 10 });
    ...
    it("should handle multiple sequential calls correctly", () => {
      const results = [
        calculator.calculateRates({ year: 2020, month: 6 }),
        calculator.calculateRates({ year: 2024, month: 9 }),
        calculator.calculateRates({ year: 2025, month: 1 }),
        calculator.calculateRates({ year: 1999, month: 12 }),
      ];
    ...
    it("should not be affected by previous calls", () => {
      calculator.calculateRates({ year: 2024, month: 10 });
      calculator.calculateRates({ year: 1999, month: 1 });
      const result = calculator.calculateRates({ year: 2024, month: 10 });
  ...
  describe("calculate - Timeline Logic Validation", () => {
    ...
    it("should compare year first, then month", () => {
      const resultBeforeYear = calculator.calculateRates({ year: 2023, month: 12 });
      const resultAfterYear = calculator.calculateRates({ year: 2024, month: 1 });
    ...
    it("should handle exact match on year and month", () => {
      const result1 = calculator.calculateRates({ year: 2000, month: 1 });
      const result2 = calculator.calculateRates({ year: 2024, month: 9 });
  ...
  describe("Integration Scenarios", () => {
    ...
    it("should handle historical date (2015-06)", () => {
      const result = calculator.calculateRates({ year: 2015, month: 6 });
    ...
    it("should handle year boundary transition (2023-12 to 2024-01)", () => {
      const dec2023 = calculator.calculateRates({ year: 2023, month: 12 });
      const jan2024 = calculator.calculateRates({ year: 2024, month: 1 });
    ...
    it("should handle rate change month (August to September 2024)", () => {
      const aug = calculator.calculateRates({ year: 2024, month: 8 });
      const sep = calculator.calculateRates({ year: 2024, month: 9 });
    ...
    it("should calculate rate increase percentage", () => {
      const rates2000 = calculator.calculateRates({ year: 2020, month: 1 });
      const rates2024 = calculator.calculateRates({ year: 2024, month: 10 });
  ...
  describe("Real-world Date Scenarios", () => {
    it("should handle all months of 2022", () => {
      const results = Array.from({ length: 12 }, (_, i) =>
        calculator.calculateRates({ year: 2022, month: i + 1 })
      );
    ...
    it("should handle all months of 2024 with correct transition", () => {
      const results = Array.from({ length: 12 }, (_, i) =>
        calculator.calculateRates({ year: 2024, month: i + 1 })
      );
    ...
    it("should handle quarterly periods in 2024", () => {
      const q1 = calculator.calculateRates({ year: 2024, month: 3 }); // March
      const q2 = calculator.calculateRates({ year: 2024, month: 6 }); // June
      const q3 = calculator.calculateRates({ year: 2024, month: 9 }); // September
      const q4 = calculator.calculateRates({ year: 2024, month: 12 }); // December
    ...
    it("should handle fiscal year transitions", () => {
      const fiscal2023 = calculator.calculateRates({ year: 2023, month: 12 });
      const fiscal2024 = calculator.calculateRates({ year: 2024, month: 1 });
      const fiscal2025 = calculator.calculateRates({ year: 2025, month: 1 });
