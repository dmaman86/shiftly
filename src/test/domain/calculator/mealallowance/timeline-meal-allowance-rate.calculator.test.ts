...
describe("TimelineMealAllowanceRateCalculator", () => {
  let calculator: TimelineMealAllowanceRateCalculator;
  ...
  beforeEach(() => {
    calculator = new TimelineMealAllowanceRateCalculator();
  });
  ...
  describe("calculate - Rate Values", () => {
    ...
    it("should show rate increase from 2000 to 2024", () => {
      const rates2000 = calculator.calculate({ year: 2020, month: 6 });
      const rates2024 = calculator.calculate({ year: 2024, month: 10 });
    ...
    it("should have large rate greater than small rate", () => {
      const rates2000 = calculator.calculate({ year: 2010, month: 6 });
      const rates2024 = calculator.calculate({ year: 2024, month: 10 });
  ...
  describe("calculate - Consistency and Determinism", () => {
    ...
    it("should return consistent results across multiple instances", () => {
      const calculator1 = new TimelineMealAllowanceRateCalculator();
      const calculator2 = new TimelineMealAllowanceRateCalculator();
  ...
  describe("Integration Scenarios", () => {
    ...
    it("should calculate rate increase percentage", () => {
      const rates2000 = calculator.calculate({ year: 2020, month: 1 });
      const rates2024 = calculator.calculate({ year: 2024, month: 10 });
