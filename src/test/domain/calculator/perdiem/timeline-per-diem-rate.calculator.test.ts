...
describe("TimelinePerDiemRateCalculator", () => {
  let calculator: TimelinePerDiemRateCalculator;
  ...
  beforeEach(() => {
    calculator = new TimelinePerDiemRateCalculator();
  });

  describe("calculate - Before Timeline Start", () => {
    it("should return default rate (0) for year before 2000", () => {
      const result = calculator.calculate({ year: 1999, month: 12 });
    ...
    it("should return default rate for year 1990", () => {
      const result = calculator.calculate({ year: 1990, month: 6 });

      expect(result).toBe(RATE_DEFAULT);
    });

    it("should return default rate for year 1980", () => {
      const result = calculator.calculate({ year: 1980, month: 1 });
    ...
    it("should return default rate for January 2000 (before month 1)", () => {
      ...
      const result = calculator.calculate({ year: 2000, month: 0 });
  ...
  describe("calculate - First Timeline Entry (2000-01)", () => {
    it("should return 2000 rate for January 2000 (exact match)", () => {
      const result = calculator.calculate({ year: 2000, month: 1 });
    ...
    it("should return 2000 rate for February 2000", () => {
      const result = calculator.calculate({ year: 2000, month: 2 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for June 2000", () => {
      const result = calculator.calculate({ year: 2000, month: 6 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for December 2000", () => {
      const result = calculator.calculate({ year: 2000, month: 12 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for year 2001", () => {
      const result = calculator.calculate({ year: 2001, month: 1 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for year 2010", () => {
      const result = calculator.calculate({ year: 2010, month: 6 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for year 2020", () => {
      const result = calculator.calculate({ year: 2020, month: 12 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for year 2023", () => {
      const result = calculator.calculate({ year: 2023, month: 12 });
  ...
  describe("calculate - Second Timeline Entry (2024-09)", () => {
    it("should return 2024 rate for September 2024 (exact match)", () => {
      const result = calculator.calculate({ year: 2024, month: 9 });
    ...
    it("should return 2024 rate for October 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 10 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should return 2024 rate for December 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 12 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should return 2024 rate for January 2025", () => {
      const result = calculator.calculate({ year: 2025, month: 1 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should return 2024 rate for year 2026", () => {
      const result = calculator.calculate({ year: 2026, month: 6 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should return 2024 rate for far future year 2030", () => {
      const result = calculator.calculate({ year: 2030, month: 12 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should return 2024 rate for year 2100", () => {
      const result = calculator.calculate({ year: 2100, month: 1 });
  ...
  describe("calculate - Transition Between Entries", () => {
    it("should return 2000 rate for January 2024 (before September)", () => {
      const result = calculator.calculate({ year: 2024, month: 1 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for February 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 2 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for March 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 3 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for April 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 4 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for May 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 5 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for June 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 6 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for July 2024", () => {
      const result = calculator.calculate({ year: 2024, month: 7 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should return 2000 rate for August 2024 (one month before)", () => {
      const result = calculator.calculate({ year: 2024, month: 8 });

      expect(result).toBe(RATE_2000_01);
    });

    it("should transition to 2024 rate exactly at September 2024", () => {
      const august = calculator.calculate({ year: 2024, month: 8 });
      const september = calculator.calculate({ year: 2024, month: 9 });
  ...
  describe("calculate - Month Boundaries", () => {
    ...
    it("should handle month 12 (December/last month)", () => {
      const result2023 = calculator.calculate({ year: 2023, month: 12 });
      const result2024 = calculator.calculate({ year: 2024, month: 12 });
    ...
    it("should handle all months in year 2024", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculate({ year: 2024, month });
    ...
    it("should handle all months in year 2010", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculate({ year: 2010, month });
        expect(result).toBe(RATE_2000_01);
      }
    });
    ...
    it("should handle all months in year 2025", () => {
      for (let month = 1; month <= 12; month++) {
        const result = calculator.calculate({ year: 2025, month });
        expect(result).toBe(RATE_2024_09);
      }
    });
  });
  ...
  describe("calculate - Rate Values", () => {
    ...
    it("should show rate increase from 2000 to 2024", () => {
      const rate2000 = calculator.calculate({ year: 2020, month: 6 });
      const rate2024 = calculator.calculate({ year: 2024, month: 10 });
    ...
    it("should return exact numeric values without floating point errors", () => {
      const result2000 = calculator.calculate({ year: 2010, month: 6 });
      const result2024 = calculator.calculate({ year: 2024, month: 10 });
  ...
  describe("calculate - Edge Cases", () => {
    it("should handle month 0 (edge case)", () => {
      const result = calculator.calculate({ year: 2024, month: 0 });
    ...
    it("should handle month 13 (edge case)", () => {
      const result = calculator.calculate({ year: 2024, month: 13 });
    ...
    it("should handle negative year (edge case)", () => {
      const result = calculator.calculate({ year: -1, month: 6 });

      expect(result).toBe(RATE_DEFAULT);
    });

    it("should handle very large year", () => {
      const result = calculator.calculate({ year: 9999, month: 12 });

      expect(result).toBe(RATE_2024_09);
    });

    it("should handle year 0 (edge case)", () => {
      const result = calculator.calculate({ year: 0, month: 1 });
  ...
  describe("calculate - Return Value Structure", () => {
    ...
    it("should return valid numeric value even for dates before timeline", () => {
      const result = calculator.calculate({ year: 1990, month: 1 });
  ...
  describe("calculate - Consistency and Determinism", () => {
    it("should return consistent results for same input", () => {
      const result1 = calculator.calculate({ year: 2024, month: 10 });
      const result2 = calculator.calculate({ year: 2024, month: 10 });
      const result3 = calculator.calculate({ year: 2024, month: 10 });
    ...
    it("should return consistent results across multiple instances", () => {
      const calculator1 = new TimelinePerDiemRateCalculator();
      const calculator2 = new TimelinePerDiemRateCalculator();

      const result1 = calculator1.calculate({ year: 2024, month: 10 });
      const result2 = calculator2.calculate({ year: 2024, month: 10 });
    ...
    it("should handle multiple sequential calls correctly", () => {
      const results = [
        calculator.calculate({ year: 2020, month: 6 }),
        calculator.calculate({ year: 2024, month: 9 }),
        calculator.calculate({ year: 2025, month: 1 }),
        calculator.calculate({ year: 1999, month: 12 }),
      ];
    ...
    it("should not be affected by previous calls", () => {
      calculator.calculate({ year: 2024, month: 10 });
      calculator.calculate({ year: 1999, month: 1 });
      const result = calculator.calculate({ year: 2024, month: 10 });
  ...
  describe("calculate - Timeline Logic Validation", () => {
    ...
    it("should compare year first, then month", () => {
      const resultBeforeYear = calculator.calculate({ year: 2023, month: 12 });
      const resultAfterYear = calculator.calculate({ year: 2024, month: 1 });
    ...
    it("should handle exact match on year and month", () => {
      const result1 = calculator.calculate({ year: 2000, month: 1 });
      const result2 = calculator.calculate({ year: 2024, month: 9 });
  ...
  describe("Integration Scenarios", () => {
    ...
    it("should handle historical date (2015-06)", () => {
      const result = calculator.calculate({ year: 2015, month: 6 });

      expect(result).toBe(33.9);
    });

    it("should handle year boundary transition (2023-12 to 2024-01)", () => {
      const dec2023 = calculator.calculate({ year: 2023, month: 12 });
      const jan2024 = calculator.calculate({ year: 2024, month: 1 });
    ...
    it("should handle rate change month (August to September 2024)", () => {
      const aug = calculator.calculate({ year: 2024, month: 8 });
      const sep = calculator.calculate({ year: 2024, month: 9 });
    ...
    it("should calculate rate increase percentage", () => {
      const rate2000 = calculator.calculate({ year: 2020, month: 1 });
      const rate2024 = calculator.calculate({ year: 2024, month: 10 });
  ...
  describe("Real-world Date Scenarios", () => {
    it("should handle all months of 2022", () => {
      const results = Array.from({ length: 12 }, (_, i) =>
        calculator.calculate({ year: 2022, month: i + 1 })
      );
    ...
    it("should handle all months of 2024 with correct transition", () => {
      const results = Array.from({ length: 12 }, (_, i) =>
        calculator.calculate({ year: 2024, month: i + 1 })
      );
    ...
    it("should handle quarterly periods in 2024", () => {
      const q1 = calculator.calculate({ year: 2024, month: 3 }); // March
      const q2 = calculator.calculate({ year: 2024, month: 6 }); // June
      const q3 = calculator.calculate({ year: 2024, month: 9 }); // September
      const q4 = calculator.calculate({ year: 2024, month: 12 }); // December
    ...
    it("should handle fiscal year transitions", () => {
      const fiscal2023 = calculator.calculate({ year: 2023, month: 12 });
      const fiscal2024 = calculator.calculate({ year: 2024, month: 1 });
      const fiscal2025 = calculator.calculate({ year: 2025, month: 1 });
    ...
    it("should handle leap year transition (February 2024)", () => {
      const feb2024 = calculator.calculate({ year: 2024, month: 2 });
      const mar2024 = calculator.calculate({ year: 2024, month: 3 });
  ...
  describe("Sorting and Filtering Logic", () => {
    it("should correctly filter entries before or equal to requested date", () => {
      ...
      const resultAugust = calculator.calculate({ year: 2024, month: 8 });
    ...
    it("should correctly filter both entries for September 2024 and pick latest", () => {
      ...
      const resultSeptember = calculator.calculate({ year: 2024, month: 9 });
    ...
    it("should return first element after sorting", () => {
      const result = calculator.calculate({ year: 2025, month: 6 });
  ...
  describe("Comparison with Similar Resolvers", () => {
    it("should follow same timeline pattern as meal allowance calculator", () => {
      ...
      transitionalMonths.forEach(({ year, month, expected }) => {
        const result = calculator.calculate({ year, month });
        expect(result).toBe(expected);
      });
    });

    it("should have rate increase proportional to other allowances", () => {
      const rate2000 = calculator.calculate({ year: 2010, month: 1 });
      const rate2024 = calculator.calculate({ year: 2024, month: 10 });
  ...
  describe("Business Rules Validation", () => {
    ...
    it("should return consistent rate for entire effective period", () => {
      ...
      const sep2024 = calculator.calculate({ year: 2024, month: 9 });
      const oct2024 = calculator.calculate({ year: 2024, month: 10 });
      const dec2024 = calculator.calculate({ year: 2024, month: 12 });
