...
export const BreakdownUtils = (() => {
  ...
  const sumBreakdowns = (
    ...
    special: {
      ...
      extra100Shabbat: {
        ...
        hours:
          a.special.extra100Shabbat.hours + b.special.extra100Shabbat.hours,
      },
    },
    hours100Sick: {
      ...a.hours100Sick,
  ...
  const subtractBreakdowns = (
    ...
    regular: {
      hours100: {
        ...a.regular.hours100,
        hours: subtractValues(
          a.regular.hours100.hours,
          b.regular.hours100.hours,
        ),
      },
      hours125: {
        ...a.regular.hours125,
        hours: subtractValues(
          a.regular.hours125.hours,
          b.regular.hours125.hours,
        ),
      },
      hours150: {
        ...a.regular.hours150,
        hours: subtractValues(
          a.regular.hours150.hours,
          b.regular.hours150.hours,
        ),
      },
      hours20: {
        ...a.regular.hours20,
        hours: subtractValues(a.regular.hours20.hours, b.regular.hours20.hours),
      },
      hours50: {
        ...a.regular.hours50,
        hours: subtractValues(a.regular.hours50.hours, b.regular.hours50.hours),
      },
    },
    special: {
      shabbat150: {
        ...a.special.shabbat150,
        hours: subtractValues(
          a.special.shabbat150.hours,
          b.special.shabbat150.hours,
        ),
      },
      shabbat200: {
        ...a.special.shabbat200,
        hours: subtractValues(
          a.special.shabbat200.hours,
          b.special.shabbat200.hours,
        ),
      },
      extra100Shabbat: {
        ...a.special.extra100Shabbat,
        hours: subtractValues(
          a.special.extra100Shabbat.hours,
          b.special.extra100Shabbat.hours,
        ),
      },
    },
    hours100Sick: {
      ...a.hours100Sick,
      hours: subtractValues(a.hours100Sick.hours, b.hours100Sick.hours),
    },
    hours100Vacation: {
      ...a.hours100Vacation,
      hours: subtractValues(a.hours100Vacation.hours, b.hours100Vacation.hours),
    },
    totalHours: subtractValues(a.totalHours, b.totalHours),
    totalPay: subtractValues(a.totalPay, b.totalPay),
  });

  const initBreakdown = (): WorkDayPayMap => ({
    regular: {
  ...
  return { sumBreakdowns, subtractBreakdowns, initBreakdown };
})();
