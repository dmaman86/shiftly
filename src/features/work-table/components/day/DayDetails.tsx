...
export const DayDetails = ({
  ...
  return (
    ...
    >
      ...
      >
        {primaryGroups.map(({ key: groupKey, ...group }) => (
          <DetailGroup key={groupKey} id={id} groupKey={groupKey} {...group} />
        ))}
      </Box>
      <Box
        sx={{
      ...
      >
        {secondaryGroups.map(({ key: groupKey, ...group }) => (
          <DetailGroup key={groupKey} id={id} groupKey={groupKey} {...group} />
        ))}
      </Box>
    </Box>
