...
- **Calculators**
  Pure, dependency-free functions implementing rules for classified intervals,
  regular progression and premiums, special rates, dated-rate lookups, and
  allowances.
...
│   │   ├── classification/     # Timeline classification into Regular/Special intervals
